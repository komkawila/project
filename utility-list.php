...
<?php  //	ถ้าไม่มีข้อมูล
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-condensed  table-hover">
        <tr>
          <td width="13%" align="center" valign="middle" class="txt_top1"><strong>ลำดับ</strong></td>
          <td width="52%" align="left" valign="middle" class="txt_top1"><strong>ชื่อสาธารณูปโภค</strong></td>
          <td width="16%" align="left" valign="middle" class="txt_top1"><strong>ราคา/หน่วย</strong></td>
          <td width="10%" align="center" valign="middle" class="txt_top1"><i class="icon-edit"></i> <strong>  แก้ไข</strong></td>
          <td width="9%" align="center" valign="middle" class="txt_top2"><i class="icon-trash"></i> <strong> ลบ</strong></td>
        </tr>
...
?>
         ...
         <tr class="report">
          <td width="13%" align="center" valign="middle" class="txt_report-1"><?=$no?></td>
          <td align="left" valign="middle" class="txt_report-1"><?=$utility_name?></td>
          <td align="left" valign="middle" class="txt_report-1"><?=number_format($utility_unit_price,2)?>  </td>
          <td width="10%" align="center" valign="middle" class="link1">
		  <a  href="?stt=edit&ID=<?=$ID?>"><i class="icon-edit"></i> แก้ไข</a> </td>
          <td width="9%" align="center" valign="middle" class="link2"> 
